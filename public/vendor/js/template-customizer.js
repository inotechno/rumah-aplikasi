!(function () {
    ...
    !(function () {
        ...
        var b = [
            ...
            k = !!x.contains("layout-menu-collapsed"),
            F = !!x.contains("layout-menu-flipped"),
                ...
                function t(e) {
                    ...
                    if (
                        ...
                        if (
                            ...
                            (this.settings.cssFilenamePattern =
                                a || "%name%.css"),
                            ...
                            -1 !== N &&
                                (this.settings.controls = this.settings.controls
                                    .slice(0, N)
                                    .concat(
                                        this.settings.controls.slice(N + 1)
                                    ));
                        }
                ...
                return (
                    ...
                    (s = [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var t,
                                    ...
                                    a = this._getSetting("LayoutMenuFlipped"),
                                    o = this._getSetting("ShowDropdownOnHover"),
                                ...
                                (t =
                                    ...
                                    this._hasControls("style") ||
                                        (this.settings.style = x.contains(
                                            "dark-style"
                                        )
                                            ? "dark"
                                            : "light"),
                            ...
                            value: function () {
                                ...
                                if (
                                    ...
                                    if (this._hasControls("layoutType")) {
                                        ...
                                        var _ = function (e) {
                                            return t.setLayoutType(
                                                e.target.value
                                            );
                                        };
                                        this._controls.layoutType.addEventListener(
                                            "change",
                                            _
                                        ),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                for (
                                    var t = 0, e = this._listeners.length;
                                    t < e;
                                    t++
                                )
