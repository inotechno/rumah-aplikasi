...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('service.update', $service->id) }}" method="POST" class="needs-validation" novalidate>
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('service_name') is-invalid @enderror"
                                name="service_name" required value="{{ $service->service_name }}">
                            @error('service_name')
                    ...
                    <div class="col-md">
                        <div class="form-group">
                            ...
                            <textarea name="service_description" class="form-control @error('service_description') is-invalid @enderror"
                                id="" cols="30" rows="10">{{ $service->service_description }}</textarea>
