                        ...
                        <article class="blog-details">
                            ...
                            <div class="post-img">
                                <img src="{{ asset('storage/posts/' . $post->img_thumbnail) }}"
                                    alt="{{ $post->slug_title }}" class="img-fluid" width="100%">
                            </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="sidebar">
                            ...
                            <div class="sidebar-item recent-posts">
                                <h3 class="sidebar-title">Post Others</h3>

                                <div class="mt-3">
                                    @foreach ($latest_posts as $latest)
                                        <div class="post-item mt-3">
                                            <img src="{{ asset('storage/posts/' . $latest->img_thumbnail) }}"
                                                alt="" class="flex-shrink-0">
                                            <div>
                                                <h4><a
                                                        href="{{ route('post.detail', $latest->slug_title) }}">{{ $latest->title }}</a>
                                                </h4>
                                                <time
                                                    datetime="{{ date('Y-m-d', strtotime($post->created_at)) }}">{{ date('d M Y', strtotime($post->created_at)) }}</time>
                                            </div>
                                        </div>
                                    @endforeach
