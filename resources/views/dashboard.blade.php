                ...
                <div class="d-flex align-items-end row">
                    <div class="col-sm-7">
                        <div class="card-body">
                            ...
                            <p class="mb-4">Dashboard ini digunakan untuk mengelola berbagai konten yang ada pada rumah
                                aplikasi.</p>
                            ...
                            <div class="timeline-event">
                                ...
                                <div class="d-flex">
                                    <a href="javascript:void(0)" class="d-flex align-items-center me-3">
                                        <img src="{{ asset('img/icons/misc/pdf.png') }}" alt="PDF image" width="23"
                                            class="me-2">
                            ...
                            <div class="timeline-event">
                                ...
                                <div class="d-flex flex-wrap">
                                    <div class="avatar me-3">
                                        <img src="{{ asset('img/avatars/3.png') }}" alt="Avatar"
                            ...
                            <div class="timeline-event pb-0">
                                ...
                                <div class="d-flex align-items-center avatar-group">
                                    <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                        ...
                                        <img src="{{ asset('img/avatars/5.png') }}" alt="Avatar"
                                            class="rounded-circle">
                                    </div>
                                    <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                        data-bs-placement="top" title="Marrie Patty">
                                        <img src="{{ asset('img/avatars/12.png') }}" alt="Avatar"
                                            class="rounded-circle">
                                    </div>
                                    <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                        data-bs-placement="top" title="Jimmy Jackson">
                                        <img src="{{ asset('img/avatars/9.png') }}" alt="Avatar"
                                            class="rounded-circle">
                                    </div>
                                    <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                        data-bs-placement="top" title="Kristine Gill">
                                        <img src="{{ asset('img/avatars/6.png') }}" alt="Avatar"
                                            class="rounded-circle">
                                    </div>
                                    <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                        data-bs-placement="top" title="Nelson Wilson">
                                        <img src="{{ asset('img/avatars/14.png') }}" alt="Avatar"
                                            class="rounded-circle">
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="table table-borderless text-nowrap">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('img/icons/brands/chrome.png') }}" alt="Chrome"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('img/icons/brands/safari.png') }}" alt="Safari"
                                                    height="24" class="me-2">
                                                <span>Safari</span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('img/icons/brands/firefox.png') }}" alt="Firefox"
                                                    height="24" class="me-2">
                                                <span>Firefox</span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('img/icons/brands/edge.png') }}" alt="Edge"
                                                    height="24" class="me-2">
                                                <span>Edge</span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('img/icons/brands/opera.png') }}" alt="Opera"
                                                    height="24" class="me-2">
                                                <span>Opera</span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('img/icons/brands/brave.png') }}" alt="Brave"
                                                    height="24" class="me-2">
                                                <span>Brave</span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('img/icons/brands/vivaldi.png') }}" alt="Vivaldi"
                                                    height="24" class="me-2">
                                                <span>Vivaldi</span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('img/icons/brands/uc.png') }}" alt="UC Browser"
                                                    height="24" class="me-2">
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('img/icons/brands/windows.png') }}" alt="Windows"
                                                    height="24" class="me-2">
                                                <span>Windows</span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('img/icons/brands/mac.png') }}" alt="Mac"
                                                    height="24" class="me-2">
                                                <span>Mac</span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('img/icons/brands/ubuntu.png') }}" alt="Ubuntu"
                                                    height="24" class="me-2">
                                                <span>Ubuntu</span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('img/icons/brands/cent.png') }}" alt="Cent"
                                                    height="24" class="me-2">
                                                <span>Cent</span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('img/icons/brands/linux.png') }}" alt="Linux"
                                                    height="24" class="me-2">
                                                <span>Linux</span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('img/icons/brands/fedora.png') }}" alt="Fedora"
                                                    height="24" class="me-2">
                                                <span>Fedora</span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('img/icons/brands/vivaldi-os.png') }}" alt="Vivaldi"
                                                    height="24" class="me-2">
                                                <span>Vivaldi</span>
                                            </div>
                                        </td>
