        ...
        <div class="app-brand mb-5">
            <a href="index-2.html" class="app-brand-link gap-2">
                <span class="app-brand-logo demo">
                    ...
                    <img width="30" height="30" src="{{ asset('img/' . config('settings.app_logo_crop')) }}"
                        alt="">

                </span>
                <span class="app-brand-text demo text-body fw-bolder">{{ config('settings.app_name') }}</span>
            </a>
        </div>
        <!-- /Logo -->
        <h4 class="mb-2">Welcome to {{ config('settings.app_name') }}! 👋</h4>
